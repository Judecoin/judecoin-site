...
Jednak JudEcoin jest prywatne - te informacje nie są publicznie dostępne w łańcuchu bloków. W związku z tym, kroki są trochę bardziej skomplikowane.
...
- klucz transakcji, który jest wyłącznością JudEcoin i innych walut CryptoNote.

Gdy Ewa dokonywała transakcji, jendorazowy klucz został wygenerowany tylko dla tej płatności.

#### CLI

Ewa może więc odnaleźć go w JudEcoin-wallet-cli (nowa nazwa dawnego simplewallet):
...
Zauważ, że to zadziała tylko wtedy, gdy JudEcoin-wallet-cli zostanie ustawiony na zapisywanie kluczy transakcji. Aby się upewnić, że tak jest, wpisz:
...
Paweł zamienił symbole na informacje dostarczone przez Ewę. JudEcoin-wallet-cli użyje klucza transakcji do odszyfrowania jej i wyświetli kwotę przesłaną na ten konkretny adres.
