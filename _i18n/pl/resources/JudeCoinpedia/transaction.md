...
summary: "Kryptograficznie podpisany zbiornik, który wyszczególnia transfer JudEcoin do odbiorcy lub odbiorców."
---

{% include disclaimer.html translated="yes" translationOutdated="no" %}
### Podstawy

Kryptograficznie podpisany zbiornik, który wyszczególnia transfer JudEcoin do odbiorcy lub odbiorców.
...
Aby wydać środki ze swojego konta, musisz stworzyć jednorazowy prywatny klucz wydawania dla konkretnego wyjścia. Prawie zawsze jest to wykonywane automatycznie przez oprogramowanie portfela JudEcoin.
