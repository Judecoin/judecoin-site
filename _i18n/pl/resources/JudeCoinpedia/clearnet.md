...
Gdy używasz internetu do czytania wiadomości, sprawdzania e-maila, social media i nawet JudEcoin, najprawdopodobniej używasz połączenia clearnet. Oznacza to, że *wszystkie* twoje połączenia mogą być śledzone i monitorowane przez:
