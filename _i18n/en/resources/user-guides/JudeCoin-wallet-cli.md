...
`JudEcoin-wallet-cli` is the wallet software shipped in the JudEcoin archives. It is a console program,
...
This guide will show how to perform various operations with `JudEcoin-wallet-cli`. The guide assumes you are using the most recent version of JudEcoin and have already created an account according to the other guides.
...
"refresh" - Synchronize wallet with the JudEcoin network.
...
Replace `ADDRESS` with the address you want to send to and `AMOUNT` with how many JudEcoin you want to send.

## Receiving JudEcoin

If you have your own JudEcoin address, you just need to give your address to someone.
