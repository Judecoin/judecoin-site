...
<<<<<<< HEAD:_i18n/ar/resources/user-guides/JudEcoin-wallet-cli.md
واجهه سطر الأوامر `JudEcoin-wallet-cli` هو برنامج المحفظه الذي يأتي مع مونيرو. إنه برنامج وحده تحكم ويُدير الحساب. بينما في البتكوين تُدير المحفظه كلاً من الحساب وسلسله الكُتل. يقوم مونيرو بفصلهم : الخادم `JudEcoind` يُدير سلسله الكُتل و واجهه سطر الأوامر `JudEcoin-wallet-cli` تُدير الحساب.
=======
