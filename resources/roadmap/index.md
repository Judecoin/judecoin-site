            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="tabPanel-widget">
                    ...
                    <div class="tabPanel-content info-block">
                        ...
                        <ul>
                                <h3 class="months">{% t roadmap.jan %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2016/01/01/JudEcoin-0.9.0-hydrogen-helix-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-9-0 %}</a></li>
                                ...
                                <h3 class="months">{% t roadmap.sep %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2016/09/19/JudEcoin-0.10.0-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-10-0 %}</a></li>
                                    <li class="completed">{% t roadmap.splitcoinbase %}</li>
                                <h3 class="months">{% t roadmap.dec %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2016/12/14/JudEcoin-0.10.1-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-10-1 %}</a></li>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2016/12/22/JudEcoin-core-gui-beta-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.guibeta1 %}</a></li>
                            </ul>
                    </div>
                    ...
                    <div class="tabPanel-content info-block">
                        <h2>2017</h2>
                            <ul>
                                ...
                                <h3 class="months">{% t roadmap.feb %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2017/02/23/JudEcoin-0.10.2-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-10-2 %}</a></li>
                                <h3 class="months">{% t roadmap.mar %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2017/03/27/JudEcoin-0.10.3.1-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-10-3-1 %}</a></li>
                                <h3 class="months">{% t roadmap.apr %}</h3>
                                    <li class="completed">{% t roadmap.hfminblock %}</li>
                                <h3 class="months">{% t roadmap.jul %}</h3>
                                    <li class="completed">{% t roadmap.webredesign %}</li>
                                <h3 class="months">{% t roadmap.sep %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2017/09/07/JudEcoin-0.11.0.0-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-11-0 %}</a></li>
                                ...
                                <h3 class="months">{% t roadmap.oct %}</h3>
                                    ...
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2017/10/27/JudEcoin-0.11.1.0-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.release-0-11-1 %}</a></li>
                    ...
                    <div class="tabPanel-content info-block">
                        <h2>2018</h2>
                            <ul>
                                <h3 class="months">{% t roadmap.mar %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2018/03/29/JudEcoin-0.12.0.0-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-12-0 %}</a></li>
                                <h3 class="months">{% t roadmap.apr %}</h3>
                                    ...
                                    <li class="completed">{% t roadmap.getJudEcoin-fr-pl %}</li>
                                ...
                                <h3 class="months">{% t roadmap.aug %}</h3>
                                    ...
                                    <li class="completed">{% t roadmap.JudEcoinpedialoc %}</li>
                                    <li class="completed">{% t roadmap.getJudEcoin-ar %}</li>
                                <h3 class="months">{% t roadmap.oct %}</h3>
                    ...
                    <div class="tabPanel-content info-block">
                        <h2>2019</h2>
                            <ul>
                                <h3 class="months">{% t roadmap.feb %}</h3>
                                    <li class="completed">{% t roadmap.getJudEcoin-de %}</li>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2019/02/25/JudEcoin-0.14.0-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-14-0 %}</a></li>
                                <h3 class="months">{% t roadmap.mar %}</h3>
                                    <li class="completed">{% t roadmap.releasedgui-0-14-0 %}</li>
                                    <li class="completed">{% t roadmap.ccs %}</li>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2019/03/08/JudEcoin-0.14.2-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-14-0-2 %}</a></li>
                                    <li class="completed">{% t roadmap.cryptonightr %}</li>
                                    <li class="completed">{% t roadmap.getJudEcoin-pt_br %}</li>
                                <h3 class="months">{% t roadmap.may %}</h3>
                    ...
                    <div class="tabPanel-content info-block">
                        <h2>2020</h2>
                            <ul>
                                <h3 class="months">{% t roadmap.feb %}</h3>
                                    <li class="completed">{% t roadmap.getJudEcoinweblate %}</li>
                                <h3 class="months">{% t roadmap.mar %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2020/03/05/JudEcoin-GUI-0.15.0.4-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.releasedgui-0-15-0-4 %}</a></li>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2020/03/19/JudEcoin-0.15.0.5-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-15-0-5 %}</a></li>
                                <h3 class="months">{% t roadmap.apr %}</h3>
                                    <li class="completed">{% t roadmap.dandelion %}</li>
                                <h3 class="months">{% t roadmap.may %}</h3>
                                    <li class="completed"><a href="{{ site.baseurl_root }}/2020/05/23/JudEcoin-0.16-released.html" target="_blank" rel="noreferrer noopener">{% t roadmap.released-0-16-0-0 %}</a></li>
                                <h3 class="months">{% t roadmap.aug %}</h3>
