...
Where `ENTRY` is a one word identifier for the title/name of your JudEcoinpedia entry. For example, if you are adding a new JudEcoinpedia entry called "Daemon", it can be `JudEcoinpedia.entries.daemon`.
